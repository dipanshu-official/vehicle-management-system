...
import { addVehicle, updateVehicle, getVehicleById } from '../../utils/storage';
...
export const VehicleFormPage = () => {
  ...
  if (initialLoading) {
    return <LoadingSpinner size="lg" text="Loading vehicle..." className="py-12" />;
  }
        ...
        <div className="flex items-center">
          ...
          <div>
            ...
            <p className="text-gray-600">
              {isEditing ? 'Update vehicle information' : 'Register a new vehicle in your fleet'}
            </p>
          </div>
        </div>
      </div>
